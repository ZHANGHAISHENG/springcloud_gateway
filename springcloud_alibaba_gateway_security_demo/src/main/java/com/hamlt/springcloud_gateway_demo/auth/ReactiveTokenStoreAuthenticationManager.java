 ...
 * @date 2020-07-21 1:18
 **/
@Slf4j
public class ReactiveTokenStoreAuthenticationManager implements ReactiveAuthenticationManager {

    private TokenStore tokenStore;

    public ReactiveTokenStoreAuthenticationManager(TokenStore tokenStore){
